...
<script type="text/javascript" src="{{URL::to('assets/js/plugins/scrolltotop/scrolltopcontrol.js')}}"></script>
<script type="text/javascript" src="{{URL::to('assets/js/plugins/morris/raphael-min.js')}}"></script>
<script type="text/javascript" src="{{URL::to('assets/js/plugins/morris/morris.min.js')}}"></script>       
<script type="text/javascript" src="{{URL::to('assets/js/plugins/rickshaw/d3.v3.js')}}"></script>
...
<script type="text/javascript" src="{{URL::to('assets/js/actions.js')}}"></script>
